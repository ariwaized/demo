...
export const PortfolioView: React.FC<PortfolioProps> = ({ setView }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div className="glass-panel gravity-card" style={{ padding: '24px' }} id="portfolio-allocation-card">
        ...
        <div style={{ display: 'flex', gap: '24px', fontSize: '0.9rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ color: 'var(--text-secondary)' }}>מניות:</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ color: 'var(--text-secondary)' }}>מזומן וירטואלי:</span>
      ...
      {/* Holdings list */}
      <div className="glass-panel gravity-card" style={{ padding: '24px' }} id="portfolio-holdings-card">
        <h3 style={{ fontSize: '1.2rem', marginBottom: '16px' }}>נכסים בבעלות (Current Holdings)</h3>
      ...
      {/* Transaction history */}
      <div className="glass-panel gravity-card" style={{ padding: '24px' }} id="portfolio-history-card">

import type { AIAgent, Stock, Transaction } from '../types';
...
export function runAIAgentTrades(agents: AIAgent[], stocks: Stock[]): AIAgent[] {
  return agents.map(agent => {
    ...
    return {
      ...
      tradesCount,
      transactions: agentTxList.slice(0, 50) // Keep last 50 transactions
    };
  });
}
